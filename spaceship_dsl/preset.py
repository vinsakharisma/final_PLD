...
def ion_engine() -> Engine:
    return Engine("Ion", thrust=500.0, power_consumption=250.0, slot_cost=2, mass=100.0)

def plasma_engine() -> Engine:
    return Engine("Plasma", thrust=750.0, power_consumption=250.0, slot_cost=2, mass=750.0)

def standard_lifeSupport() -> LifeSupport:
    return LifeSupport("Standard", capacity=10, power_consumption=50.0, slot_cost=2, mass=80.0)

def advandced_lifeSupport() -> LifeSupport:
